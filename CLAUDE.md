...
**한 줄 진행도**: Phase 1 PASS · Phase 2 진행 중 (1차 백테스트 FAIL → ADR-0019 복구 로드맵 Step F PR1 PASS · PR2 PASS · PR3 FAIL). Phase 3 코드 산출물 완료 상태로 보존, 진입 금지.
...
- **테스트 카운트**: pytest **1941 collected** (Step F PR3 기준 — PR2 1830 + PR3 신규 85 함수 = parametrize 확장 후 1941. `test_strategy_momentum.py` 47 함수 + `test_backtest_momentum.py` 38 함수).
