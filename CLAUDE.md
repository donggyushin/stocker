...
**한 줄 진행도**: Phase 1 PASS · Phase 2 진행 중 (1차 백테스트 FAIL → ADR-0019 복구 로드맵 Step F PR1 PASS · PR2 PASS · PR3 FAIL · PR4 FAIL). Phase 3 코드 산출물 완료 상태로 보존, 진입 금지.
...
- **테스트 카운트**: pytest **2055 collected** (Step F PR4 기준 — PR3 1941 + PR4 신규 114. `test_strategy_low_volatility.py` 47 케이스 + `test_backtest_low_volatility.py` 38 케이스 + parametrize 확장분 29).
